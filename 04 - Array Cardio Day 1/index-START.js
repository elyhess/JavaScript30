...
var fifteen = inventors.filter(function(inventor) {
  if(inventor.year  >= 1500 && inventor.year < 1600) {
    return true; // returns the item IF you want to keep it
  }
});
console.log(fifteen)
...
// The DOM is the way Javascript sees its containing pages' data. 
// It is an object that includes how the HTML/XHTML/XML is formatted, 
// as well as the browser state. A DOM element is something like a DIV, HTML, BODY element on a page

// https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris

// var category = document.querySelector('.mw-category');
// var links = category.querySelector('a')
// var de = links
